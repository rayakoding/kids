                    ...
                    <div class="card-body">
                        ...
                        <form action="" method="POST">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-8">
                                    <input type="date" class="form-control" name="tgl" value="{{$user->tgl}}">
                                </div>
                            </div>
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="ayah" value="{{$user->ayah}}">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="inputText" class="col-sm-4 col-form-label">Golongan Darah</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="gol_darah" value="{{$user->gol_darah}}">
                                </div>
                            </div>
                            <div class="row mb-3">
