                ...
                <div class="col">
                    <div class="card">
                        <div class="card-body pt-3">
                            ...
                            <?php endif; ?>
                            <hr>
                            <a href="/periksa_ibu/edit/<?php echo e($periksa->id); ?>"class="btn btn-sm btn-primary mt-3">ubah data</a>
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Raya\Desktop\project\kids\resources\views/member/periksa/view.blade.php ENDPATH**/ ?>