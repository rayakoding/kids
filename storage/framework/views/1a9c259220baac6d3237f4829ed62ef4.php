            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <h5 class="mt-3"><strong><?php echo e(Auth::user()->name); ?></strong></h5>
                        <a class="badge bg-success mb-3"><?php echo e(Auth::user()->role); ?></a>
                        ...
                        <div class="tab-content pt-2">
                            <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-lg-9 col-md-8"><?php echo e(Auth::user()->username); ?></div>
                                </div>
                                <div class="row mb-2">
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-lg-9 col-md-8"><?php echo e(Auth::user()->tgl); ?></div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-lg-3 col-md-4 label ">Alamat</div>
                                    <div class="col-lg-9 col-md-8"><?php echo e(Auth::user()->alamat); ?></div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-lg-3 col-md-4 label ">Nomor Telepon</div>
                                    <div class="col-lg-9 col-md-8"><?php echo e(Auth::user()->telp); ?></div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-lg-3 col-md-4 label ">Pekerjaan</div>
                                    <div class="col-lg-9 col-md-8"><?php echo e(Auth::user()->pekerjaan); ?></div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-lg-3 col-md-4 label ">Nama Suami</div>
                                    <div class="col-lg-9 col-md-8"><?php echo e(Auth::user()->ayah); ?></div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-lg-3 col-md-4 label ">Golongan Darah</div>
                                    <div class="col-lg-9 col-md-8"><?php echo e(Auth::user()->gol_darah); ?></div>
                                </div>
                                <hr>
                                <div class="col">
                            ...
                            <div class="tab-pane fade show profile-overview mt-3" id="profile-kehamilan">
                                <?php if(Auth::user()->kehamilan != NULL): ?>
                                    <?php
                                    ...
                                    <?php $__currentLoopData = $kehamilan_user; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <hr>
                                        <a href="/kehamilan_ibu/view/<?php echo e($ry->id); ?>" class="btn btn-primary btn-sm mb-3"><b>Kehamilan <?php echo e($ry->hamil); ?></b></a>
                                        <div class="row mb-2">
                                ...
                                <?php else: ?>
                                    Saat ini belum ada data kehamilan, untuk menambahkan silahkan tambahkan dengan menekan tombol <a href="/kehamilan_ibu/add_id/<?php echo e(Auth::user()->id); ?>" class="btn btn-sm btn-primary">Tambah</a>
                                <?php endif; ?>
                            </div>
                            ...
                            <div class="tab-pane fade show profile-overview mt-3" id="profile-periksa">
                                <?php if(Auth::user()->kehamilan != NULL): ?>
                                    ...
                                    <?php $__currentLoopData = $kehamilan_user; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <hr>
                                    <h6><a href="/kehamilan_ibu/edit/<?php echo e($ry->id); ?>"><b>Kehamilan <?php echo e($ry->hamil); ?> / <?php echo e($ry->noreg); ?></b></a></h6>
                                    <a href="/periksa_ibu/add/<?php echo e($ry->id); ?>" class="btn btn-primary btn-sm">tambah data periksa</a>
                                        <?php
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href="/periksa_ibu/view/<?php echo e($ry->id); ?>" class="badge bg-danger">lihat</a></td>
                                                    </tr>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </tbody>
                                            </table>
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Raya\Desktop\project\kids\resources\views/admin/profile/index.blade.php ENDPATH**/ ?>