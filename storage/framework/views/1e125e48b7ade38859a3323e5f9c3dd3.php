...
<head>
  ...
  <title><?php echo e($title); ?> | KIDS</title>
...
<body>
    ...
    <footer id="footer" class="footer">
        <div class="copyright">
        &copy; Copyright <strong><span>KIDS</span></strong>. All Rights Reserved
        </div>
        <div class="credits">
        ...
        Designed by <a href="https://wa.me/6281392928080/">RayaDesain</a>
        </div>
    </footer><!-- End Footer -->
...
<?php /**PATH C:\Users\Raya\Desktop\project\kids\resources\views/admin/layouts/main.blade.php ENDPATH**/ ?>